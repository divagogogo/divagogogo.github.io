  ...
  photo: {
    left: [
      ...
      },
      {
        ...
        description: {
          name: "Life Wear",
          value: "MODEL: ADAN</br>SHOOTING IN TAIWAN",
        }, 
      },
      {
        name: "LG",
  ...
  art: {
    left: [
      ...
      },
      {
        ...
        length: 1,
        description: {
          name: "MAIA Active - Workout Anywhere (Shanghai)",
        },
      },
      {
        name: "ALC",
    ...
    center: [
      ...
      },
      {
        ...
        length: 2,
        description: {
          name: "Journey to Basskhandor Cover",
        },
      },
    ],
    right: [
    ...
    left: [
      {
        ...
        length: 7,
        description: {
          name: "WAGAS X Star Gym",
          value: "WAGAS is a famous restaurant brand at home. Its core belief is food quality and consistency. In August 2017, WAGAS cooperated with a popular TV show Star Gym, which is a entertainment show inviting the celebrities to share their experience about healthy food and exercise. According to this, WAGAS launched their special menu for each episode. </br>ROLE: PHOTOGRAPHER & DESIGNER"
        },        
      },
      {
        name: "PLA",
